import { Keyboard, KeyboardEvent, ScrollView, RefreshControl, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
...
import { CategoryType, ChecboxFilterData, CourseCardType, ErrorType } from '../constants/types';
...
export default function CoursesByCategory(props: any) {
    const category: CategoryType = props.route.params.category;
